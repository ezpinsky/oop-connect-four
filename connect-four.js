...
function updateUI(placePieceSpot) {
    ...
    for (let i = 0; i <= 5; i++) {
        ...
        for (let j = 0; j <= 6; j++) {
            let columnIndex = j;
            let selectedIndex = document.getElementById(
            ...
            let selectedColumn = document.getElementById(
                ...
                //This is a ternary operator (below) like if statement
                game.isColumnFull(columnIndex) ? selectedColumn.classList.add("full") : selectedColumn.classList.remove("full");
